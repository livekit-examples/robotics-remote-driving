...
function KeyCap({
  ...
  return (
    <div
      className={cn(
        'flex items-center justify-center rounded-lg border font-mono text-xs font-bold uppercase',
...
export function KeyOverlay({ held }: KeyOverlayProps) {
  return (
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10">
      <div className="backdrop-blur-md bg-black/30 rounded-2xl p-3 border border-white/[0.06]">
